package ru.aao.spring2ws.template.common;

public class Constant {
    public static final String NAMEPROJECT = "TemplateService";						        // название проекта
    ...
    public static final String BEFORE_IMPLEMENTATION = NAMEPROJECT + "BeforeImplementation"; // Предзаполнение маршрута
    public static final String AFTER_IMPLEMENTATION = NAMEPROJECT + "AfterImplementation";	// Пост заполнение маршрута
}
